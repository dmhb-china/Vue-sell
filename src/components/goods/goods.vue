<template>
    <div class="goods">
      <div class="menu-wrapper" ref="menuWrapper">
        <ul>
          <li v-for="(item, index) in goods" ref="menuList" :class="{'current': currentIndex === index}" :key="item.id" class="menu-item" @click="selectMenu(index,$event)">
              ...
              <li v-for="food in item.foods" :key="food.id" class="food-item border-1px">
                ...
                <div class="content">
                  ...
                  <div class="extra">
                    ...
                    <span class="favo">好评率{{food.rating}}%</span>
                  </div>
                  <div class="price">
